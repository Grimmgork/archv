class Api < Roda
	...
	route do |r|
		...
		r.post "document", "create" do
			...
			archive.call(Archivum::Command::Document::Create, title, "initial")
		end
		...
		r.post "document", Integer, "attach" do |doc_id|
			...
			archive.transaction :immediate do
				archive.call(Archivum::Command::Attachment::Create, doc_id, filename, page)
				archive.call(Archivum::Command::Attachment::WriteData, doc_id, filename, data)
			end
		end
